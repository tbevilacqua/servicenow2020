...
gr.query();
		...
		//	ownvar.addQuery('sc_item_option.item_option_new.type','!=','20'); // Container End
			...
			while(ownvar.next()) {
						...
						var invalidTypesOfVariables = [11,12,13,14,15,17,19,20];	//Array of invalid or undefined variables types
						var noob = parseInt(ownvar.sc_item_option.item_option_new.type);
